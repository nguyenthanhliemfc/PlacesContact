...
namespace PlacesContact
{
    ...
    {
        private static readonly string PlaceAPIkey = "AIzaSyBiSJsHmYaGLxgYl__RvvwK_IBdHoixjjg";
        ...
        private async void ListViewResult_OnItemSelected(object sender, SelectedItemChangedEventArgs e)
        {
            ...
            try
            {
                ...
                string email = await FindEmailFromWebsite(result.result.website);
                if(email == null || email == "")
                {
                    email = "They do not provide.";
                }
